    ...
    const WorkExp = [
        {
            ...
            projects:[
                {
                    name:"靜態活動網站" ,
                    desc:"自選素材與主題進行網頁設計，並用 HTML5 , CSS3(SCSS) , JS(ES6) 撰寫完成。",
                },
                {
                    name:"APP之介面設計" ,
        ...
        },
        {
            ...
            startdate:"2019-09",
            enddate:"2021-09",
            desc:"主要工作內容為內部系統獨立開發、資料庫模型建設與維護對外官方網站，並學習各專案牽涉之管理知識，以及學習資訊安全以及網路安全之技術與架構。",
            projects:[
                {
                    name:"行政專案管理系統" ,
                ...
                {
                    name:"官方中文網站" ,
                    desc:"專案內容與官方英文網站相同，網站詳細內容可見此網址： https://ansonnet.com.tw/"
                }
            ],
        ...
        },
        {
            ...
            startdate:"2021-09",
            enddate:"2022-06",
            desc:"同合作UI設計師共同開發網站、進修本科相關專業書籍。",
            projects:[
                {
                ...
                {
                    name:"短期進修" ,
                    desc:"因應非本科不足之處，趁自由接案期間研讀線性代數、離散數學、演算法與資料結構等科目，並閱讀相關書籍，以期自己能夠以更專業的角度進行軟體開發。"
                },
            ],
            skills:["演算法與資料結構","ReactJS"]
        },
        {
            id: v4() ,
            level:1,
